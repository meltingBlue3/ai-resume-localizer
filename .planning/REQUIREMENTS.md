...
- [x] **SKTPL-01**: 職務経歴書の職務経歴にプロジェクト経歴を含める（会社内プロジェクト→該当経歴内、個人プロジェクト→別セクション）
- [x] **SKTPL-02**: 終了日がない場合「現在」を表示する（"none"ではなく）

### 提取工作流

- [x] **EXTR-01**: `other`フィールドを新規追加して抽出する
- [x] **EXTR-02**: 言語資格を証書フィールドに統合して抽出する
- [x] **EXTR-03**: PDF出力の問題修正に対応するフィールドマッピングを更新する

### 翻訳工作流

- [x] **TRAN-01**: 未使用フィールド（linkedin, website, gpa, notes）を削除する
- [x] **TRAN-02**: PDF出力の問題修正に対応するフィールド変換ロジックを修正する
